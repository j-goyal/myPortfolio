  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-[#f6f6f6] flex flex-col w-full lg:w-[950px] shadow-lg rounded-3xl py-6 px-6 sm:px-8 md:px-12 gap-4 font-light text-md mb-8">
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4 md:gap-5 lg:gap-6">
            {skillData.map((skill, index) => (
              <div
                key={index}
                className="flex flex-col items-center border border-gray-400 justify-center gap-2 p-4 shadow-lg rounded-3xl bg-white hover:scale-110 hover:shadow-2xl transition-transform duration-200"
              >
