  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Header Section */}
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-2 mb-4 cursor-pointer">
            <div>
              <div className="flex items-center gap-2">
                <IoIosArrowDown
                  className={`w-5 h-5 text-gray-600 dark:text-gray-300 transform transition-transform duration-700 ${
                ...
                <div key={index} className="group">
                  ...
                  {responsibility.subResponsibilities && (
                    <div className="mt-2 ml-7 space-y-2">
                      {responsibility.subResponsibilities.map(
                        (sub, subIndex) => (
                          <div
                            key={subIndex}
