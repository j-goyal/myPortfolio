...
export function TopBar() {
  ...
  return (
    <div className="bg-[#f9f9f9] fixed top-0 left-0 w-full z-50 shadow h-14 flex justify-between px-4 sm:px-6 md:px-8 items-center">
      ...
      {isMenuOpen && (
        <div className="absolute top-14 left-0 w-full bg-[#f9f9f9] shadow-lg z-40">
